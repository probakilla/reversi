...
\item [Non-régression d'une IA :] Pour s'assurer de la non régression d'une IA, nous ferons s'affronter plusieurs de nos IA entre elles en gardant une trace des performances de chacune.
\end{description}
